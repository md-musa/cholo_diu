    ...
    <ScrollView className="flex-1 bg-gray-100">
      ...
      <View className="bg-indigo-600 pb-8 pt-12 px-6 rounded-b-3xl shadow-lg">
        <View className="items-center -mt-16">
          ...
          <Text className="text-2xl font-bold text-white mt-4">{""}</Text>
      ...
      <View className="px-5 mt-2 mx-5 bg-white rounded-2xl p-5 shadow-sm my-2">
        <Text className="text-lg font-semibold text-gray-800 mb-4">Developed by:</Text>
        ...
        <View className="flex-row items-start mb-4">
          ...
          <View className="ml-4 flex-1">
            <Text className="text-xl font-bold text-gray-900">Mohammad Musa</Text>
            <Text className="text-gray-600">Software Developer</Text>
            ...
            <View className="flex-row mt-3">
              ...
              <TouchableOpacity
                ...
                className="mx-2 bg-gray-100 p-2 rounded-full"
              >
        ...
        {/* Skills/Technologies */}
        <View className="mt-4">
          <Text className="text-md font-semibold text-gray-700 mb-2">Technologies Used:</Text>
          <View className="flex-row flex-wrap">
            {["React Native", "Expo", "Node.js", "TypeScript", "Tailwind CSS"].map((tech) => (
              <View key={tech} className="bg-gray-100 px-3 py-1 rounded-full mr-2 mb-2">
                <Text className="text-gray-700 text-sm">{tech}</Text>
              </View>
            ))}
          </View>
        </View>
        ...
        {/* Contact Button */}
        <TouchableOpacity
          className="mt-5 bg-indigo-600 py-3 rounded-lg flex-row items-center justify-center"
          onPress={() => Linking.openURL("mailto:mohammad.musa706@gmail.com")}
        >
